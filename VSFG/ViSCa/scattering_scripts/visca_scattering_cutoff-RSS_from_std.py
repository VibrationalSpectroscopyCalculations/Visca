...
while calc_std < exp_std:
    ...
    spec_file = 'pol_comb_sfgf%ito%i.txt'%(int(i_s[i]),int(f_s[i]))
    ...
    for spec_file in spec_files:
        spec_data = visca.Read_pol_comb_file('%s/%s'%(sfg_pol_combs_dir,spec_file), settings['Normalize_wrt']) #dict with wavenumber, SSP, PPP, SPS, PSP
